    ...
    <div class="container">
      ...
      <form action="">
        <div class="img-form">
          <!-- Форма изображения -->
          <img
            src="../assets/pexels-christina-morillo-1181690-1-66ffca7ebdddb.webp"
            alt="#"
          />
          <div class="pen">
            <img src="../assets/pencil-alt 1.svg" alt="" />
          </div>
        </div>
          ...
          <div class="left">
            ...
            <div class="name">
              ...
              <div class="select-container">
                <select id="dob">
                  <!-- Выбор даты рождения -->
                  <option value="" disabled selected>25 January 1990</option>
